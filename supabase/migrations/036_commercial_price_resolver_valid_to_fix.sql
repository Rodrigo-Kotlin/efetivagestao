-- PRC-05E-R1: Commercial Price Resolver valid_to Fix
-- Baseline: b02cea09aacc1522ed5140726128f2f3137160d4 (COMMERCIAL_PRICE_UI_VERIFIED)
-- Migrations 001-035 are IMMUTABLE.
--
-- Forward-only correction of the PRC-05C table-specific resolver. Migration
-- 035 compared the reference date with the still-unassigned PL/pgSQL variable
-- v_valid_to. This recreation preserves the accepted contract and behavior,
-- changing only that temporal predicate to compare against column v.valid_to.
